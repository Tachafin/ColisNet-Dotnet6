...
namespace _1311.Migrations
{
    ...
    [Migration("20230901234359_EditDemande")]
    partial class EditDemande
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_1311.Models.CodeBarre", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_1311.Models.Colis", b =>
                {
                    ...
                    b.Property<bool>("Ouverture_Colis")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("CodeBarreId")
                        .IsUnique()
                        .HasFilter("[CodeBarreId] IS NOT NULL");
            ...
            modelBuilder.Entity("_1311.Models.Facture", b =>
                {
                    ...
                    b.Property<int?>("Recu_PaiementId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Recu_PaiementId")
                        .IsUnique()
                        .HasFilter("[Recu_PaiementId] IS NOT NULL");
            ...
            modelBuilder.Entity("_1311.Models.Recu_Paiement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_1311.Models.Colis", b =>
                {
                    ...
                    b.HasOne("_1311.Models.CodeBarre", "CodeBarre")
                        .WithOne("Colis")
                        .HasForeignKey("_1311.Models.Colis", "CodeBarreId");
            ...
            modelBuilder.Entity("_1311.Models.Facture", b =>
                {
                    ...
                    b.HasOne("_1311.Models.Recu_Paiement", "Recu_Paiement")
                        .WithOne("Facture")
                        .HasForeignKey("_1311.Models.Facture", "Recu_PaiementId");
